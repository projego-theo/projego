          ...
          <div>
            ...
            >
              <button
                ...
                className="inline-flex items-center gap-2 cursor-pointer bg-[#29abe2] hover:bg-[#1a9fd6] text-white font-semibold px-8 py-4 rounded-full transition-all hover:-translate-y-0.5"
              >
                Démarrer mon projet
