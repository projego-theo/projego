...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/demarrer-mon-projet`, lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    ...
    { url: `${BASE_URL}/declaration-prealable-en-ligne`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/permis-construire-en-ligne`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/autoconstruction-maison`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/auto-renovation`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/demarches-administratives-construction`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
